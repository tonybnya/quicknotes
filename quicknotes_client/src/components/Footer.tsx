        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-zinc-500">
              ...
              <li><a href="/features" className="hover:text-[#FF2D85] transition-colors">Features</a></li>
              <li><a href="/docs" className="hover:text-[#FF2D85] transition-colors">API Docs</a></li>
            </ul>
          </div>
